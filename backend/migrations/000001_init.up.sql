...
CREATE INDEX IF NOT EXISTS idx_commands_device_id ON control_commands(device_id);
CREATE INDEX IF NOT EXISTS idx_alert_rules_enabled ON alert_rules(enabled);
CREATE INDEX IF NOT EXISTS idx_devices_user_status ON devices(user_id, status);
CREATE INDEX IF NOT EXISTS idx_alerts_device_triggered ON alerts(device_id, triggered_at DESC);
CREATE INDEX IF NOT EXISTS idx_commands_device_created ON control_commands(device_id, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_alerts_active ON alerts(status) WHERE status = 'triggered';
